...
treemap_data <- data_to_hierarchical(dfitemsg, group_vars = c("category", "subcategory"),
                        size_var = "sales", colors = getOption("highcharter.color_palette"))
hchart(treemap_data, type = "treemap") %>% hc_add_theme(thm)
```
